...
testCheckSc1 = testGroup "checkScriptContext1"
    ...
    , Tx.fitsInto "checkScriptContext1 (size)" (mkCheckScriptContext1Code (mkScriptContext 1)) 3665
...
testCheckSc2 = testGroup "checkScriptContext2"
    ...
    , Tx.fitsInto "checkScriptContext2 (size)" (mkCheckScriptContext2Code (mkScriptContext 1)) 3596
